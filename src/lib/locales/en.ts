export const en = {
  ...
  admin: {
    ...
    cms: {
      contentSub: "Edit headings, body copy and images for each public page.",
    ...
    careers: {
      ...
      f: {
        ...
        responsibilitiesEn: "Responsibilities (EN)", responsibilitiesAr: "Responsibilities (AR)",
        requirementsEn: "Requirements (EN)", requirementsAr: "Requirements (AR)",
        applyUrl: "External application form URL",
