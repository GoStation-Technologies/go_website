...
export const Route = createRootRouteWithContext<{
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "The fastest-growing fuel network in Saudi Arabia. Find stations, apply for a franchise, or explore investor relations." },
      { name: "theme-color", content: "#002B49" },
      { property: "og:title", content: "GoStation — A station and more" },
      { property: "og:description", content: "The fastest-growing fuel network in Saudi Arabia." },
