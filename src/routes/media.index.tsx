          ...
          <Section title={t("media.videoLibrary")}>
            <MediaCarousel>
              {videos.map((v) => (
                ...
                >
                  <article className="overflow-hidden rounded-2xl border border-border bg-card transition duration-300 hover:-translate-y-1 hover:shadow-xl">
                    <div className="relative aspect-video overflow-hidden bg-ink">
                      {v.cover_url ? (
                        <img
                          src={v.cover_url}
                          alt={lng === "ar" ? v.title_ar : v.title_en}
                          loading="lazy"
                    ...
                    <div className="p-5">
                      <div className="text-xs text-muted-foreground">{fmt(v.published_at)}</div>
                      <h3 className="mt-2 line-clamp-2 text-base font-bold">
                        {lng === "ar" ? v.title_ar : v.title_en}
                      </h3>
                    </div>
                  </article>
                </Link>
